...
from Utils.Helpers import get_ActiveRecord, get_ProcessStatus, get_RecordType, respond_to_CMS
from arcpy import GetParameterAsText, env as ENV

ENV.overwriteOutput = True


def Completion(user_name: str, password: str) -> None:
    """
...
if __name__ == "__main__":
    Completion(user_name= GetParameterAsText(0), password= GetParameterAsText(1))
