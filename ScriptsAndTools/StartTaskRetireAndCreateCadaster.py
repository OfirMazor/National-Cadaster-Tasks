...
from Utils.TypeHints import Map, Layer, Table, Scur, Editor, Icur, Polygon, Any
from Utils.VersionManagement import open_version, get_VersionName
...
def start_record_editing(Independent: bool, ProcessName: str|None, Report: bool = True) -> None:
    """
...
if __name__ == "__main__":
    start_record_editing(Independent= GetParameter(0), ProcessName= GetParameterAsText(1), Report= GetParameter(2))
