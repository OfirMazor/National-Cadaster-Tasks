from Utils.TypeHints import Literal, Extent
...
def Evaluation(qa_extent: Literal['Full map', 'Record', 'Current display'] = 'Full',
               validate_validation: bool = True,
               validate_topology: bool = True,
               validate_gaps_overlaps: bool = True,
               max_width: float = 2.0,
               validate_adjacent_points: bool = True,
               tolerance: float = 0.1,
               validate_disconnected_points: bool = True,
               validate_deviated_areas: bool = True,
               validate_redundant_vertices: bool = True,
               validate_volumetric_overlaps: bool = True) -> None:
    """
...
if __name__ == "__main__":
    ...
    Evaluation(qa_extent= GetParameterAsText(0),
