...
from Utils.UpdateAttributes import modify_CurrentAndNewFrontsAttributes, modify_PointsAttributes, modify_BlockAttributes


def update_attributes(Fronts: Optional[bool] = True, Points: Optional[bool] = True) -> None:
    """
...
if __name__ == "__main__":
    ...
    update_attributes(Fronts= GetParameter(0), Points= GetParameter(1))
