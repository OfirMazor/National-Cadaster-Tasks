...
from Utils.TypeHints import Map, Layer, Table
...
def reset_definition_queries() -> None:
    ...
    current_base_query: list[dict[str, str|bool]] = [{'name': 'Base', 'sql': 'RetiredByRecord IS NULL', 'isActive': True}]
    ...
    retired_base_query: list[dict[str, str|bool]] = [
    ...
    query: list[dict[str, str|bool]] = [{'name': 'Base', 'sql': 'OBJECTID <> -1', 'isActive': True}]
...
def drop_intermediate_layers() -> None:
    ...
    intermediates: list[str] = ['נקודות לא מתואמות', 'חזיתות לא מתואמות', 'נקודות מפנה מיותרות', 'נקודות מנותקות', 'נקודות סמוכות', 'חורים וחפיפות', 'קונפליקטים', 'חפיפות בין גריעות', 'חפיפות בין חלקות תלת-ממדיות']
