...
def eval_validation_rules() -> None:
    ...
    polygon_errors_count: int = int(GetCount(get_layer('שטחי אימות'))[0])
    line_errors_count: int = int(GetCount(get_layer('קווי אימות'))[0])
    point_errors_count: int = int(GetCount(get_layer('נקודות אימות'))[0])
